# 以下のテストケースを考慮します
#
# 1. get_json_logger関数が正しくロガーを返すか。
...
def test_get_json_logger():
    ...
    logger = get_json_logger(logger_name)
...
def test_get_json_logger_output_to_file():
    logger_name = "test_logger_file"
    logger = get_json_logger(logger_name, output_to_file=True)
